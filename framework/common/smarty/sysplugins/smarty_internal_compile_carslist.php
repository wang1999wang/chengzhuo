...
class Smarty_Internal_Compile_Carslist extends Smarty_Internal_CompileBase{
    ...
    public $optional_attributes = array('name', 'key', 't_len', 'limit', 'rec', 'limit', 'pic', 'd_len', 'type', 'urlstatic','print','order','ispage','nid','islt','cache','pinpai','leixing','fuzai','dongliyuan','gongzuochangdi','tishenggaodu');
    ...
    public function compile($args, $compiler, $parameter){
		...
		if(is_array($paramer)){
            ...
            if($paramer[\'leixing\']!=""){
				$where .=" AND `pinpai`=\'".$paramer[\'leixing\']."\'";
			}
            if($paramer[\'fuzai\']!=""){
				$where .=" AND `pinpai`=\'".$paramer[\'fuzai\']."\'";
			}
            if($paramer[\'dongliyuan\']!=""){
				$where .=" AND `pinpai`=\'".$paramer[\'dongliyuan\']."\'";
			}
            if($paramer[\'gongzuochangdu\']!=""){
				$where .=" AND `pinpai`=\'".$paramer[\'gongzuochangdu\']."\'";
			}
            if($paramer[\'tishenggaodu\']!=""){
				$where .=" AND `pinpai`=\'".$paramer[\'tishenggaodu\']."\'";
			}
			if($paramer[\'order\']!=""){
